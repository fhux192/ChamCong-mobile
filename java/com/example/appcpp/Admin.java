...
public class Admin extends AppCompatActivity {
    ...
    private Button buttonAddCompany; // Nút Thêm Công Ty
    private Button buttonAddManager; // Nút Thêm Quản Lý
    private Button buttonViewManagerList;
    private Button buttonViewCompanyList;
