...
JNIEXPORT void JNICALL Java_com_example_timekeeping_MainActivityCPP_InitFaceDetector(JNIEnv* jniEnv, jobject, jstring jFilePath) {
...
JNIEXPORT void JNICALL Java_com_example_timekeeping_MainActivityCPP_InitFaceRecognition(JNIEnv* jniEnv, jobject, jstring jFilePath) {
    const char* jnamestr = jniEnv->GetStringUTFChars(jFilePath, NULL);
    std::string filePath(jnamestr);
...
JNIEXPORT jint JNICALL Java_com_example_timekeeping_MainActivityCPP_DetectFaces(JNIEnv* env, jobject, jlong addGray, jlong addrRGBA, jfloatArray largestFaceRectArray) {
...
JNIEXPORT jfloatArray JNICALL Java_com_example_timekeeping_MainActivityCPP_ExtractFaceEmbedding(JNIEnv* env, jobject, jlong addrMat) {
...
JNIEXPORT jfloat JNICALL Java_com_example_timekeeping_MainActivityCPP_CalculateSimilarity(JNIEnv* env, jobject, jfloatArray emb1, jfloatArray emb2) {
...
JNIEXPORT void JNICALL Java_com_example_timekeeping_MainActivityCPP_LoadFaceDataList(JNIEnv* env, jobject, jstring jFilePath) {
...
JNIEXPORT void JNICALL Java_com_example_timekeeping_MainActivityCPP_SaveFaceDataList(JNIEnv* env, jobject, jstring jFilePath) {
    const char* filePathC = env->GetStringUTFChars(jFilePath, NULL);
    std::string filePath(filePathC);
...
JNIEXPORT jstring JNICALL Java_com_example_timekeeping_MainActivityCPP_CheckDuplicateFace(JNIEnv* env, jobject, jfloatArray jEmbedding, jfloat threshold) {
...
JNIEXPORT void JNICALL Java_com_example_timekeeping_MainActivityCPP_UpdateFaceData(JNIEnv* env, jobject, jstring jName, jfloatArray jEmbedding) {
